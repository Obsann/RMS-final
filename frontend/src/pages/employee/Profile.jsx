                    ...
                    <div className="px-8 pb-8">
                        <div className="flex items-end justify-between -mt-16 mb-6">
                            <div className="relative">
                                <div className="w-32 h-32 rounded-full border-4 border-white shadow-lg overflow-hidden bg-blue-500 flex items-center justify-center">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex items-center gap-2 mt-1">
                                ...
                                <p className="text-blue-600 font-semibold text-sm capitalize">
                                    {profile?.jobCategory || 'Employee'} · Staff
                                </p>
                            </div>
                        </div>
                                ...
                                <div className="col-span-1 md:col-span-2">
                                    <FormRow label="Department / Category" editMode={false}>
                                        <div className="flex items-center gap-3 px-4 py-2.5 border border-gray-100 bg-gray-50 rounded-xl text-sm text-gray-900 min-h-[42px]">
                                            ...
                                            <span>{profile?.jobCategory || 'General Employee'}</span>
