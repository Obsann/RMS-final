  ...
  new GoogleStrategy(
    {
      ...
      callbackURL: process.env.NODE_ENV === 'production' 
        ? '/api/auth/google/callback' // In production, Render handles headers well for relative paths
        : 'http://localhost:5000/api/auth/google/callback', // Force absolute URL locally
      proxy: true,
    },
